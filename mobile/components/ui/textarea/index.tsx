...
const textareaInputStyle = tva({
  base: "px-4  web:outline-0 web:outline-none flex-1 color-typography-0 placeholder:text-typography-500 web:cursor-text web:data-[disabled=true]:cursor-not-allowed",
  parentVariants: {
    size: {
      sm: "text-sm",
      md: "text-base",
